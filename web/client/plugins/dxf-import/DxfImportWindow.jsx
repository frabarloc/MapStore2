...
import DxfImportWindowContent from './DxfImportWindowContent';

class DxfWindow extends React.Component {
    static propTypes = {
    ...
    static defaultProps = {
        ...
        urlDxfFile: "http://localhost:8084/app/dxf_file"
    };
    ...
    render() {
        return this.props.withButton ? (
            <InfoButton
                ...
                className="map-logo"
                body={
                    <DxfImportWindowContent
                        urlConfigFile={this.props.urlConfigFile}
                        urlDxfFile={this.props.urlDxfFile}
                    />
                }/>) : (
            <Dialog
                id="mapstore-about"
